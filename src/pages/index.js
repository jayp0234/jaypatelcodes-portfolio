        ...
        <Layout className='pt-0 md:p-0 sm:pt-0'>
          <div className="flex items-center justify-between w-full lg:flex-col">
            <div className='w-1/2 md:w-full'>
              <AnimatedImage src={profilePic} alt="Jay Patel" className='w-full h-auto lg:hidden md:inline-block md:w-full' priority sizes="(max-width: 768px) 100vw, (max-width: 1200px) 50vw, 50vw"/>
            </div>
            <div className='w-1/2 flex flex-col items-center self-center lg:w-full lg:text-center'>
              <AnimatedText text="Engineering Your Visions into Reality" className='!text-6xl !text-left xl:!text-5xl lg:!text-center lg:!text-6xl md:!text-5xl sm:!text-3xl ' />
              <p className='my-4 text-lg font-medium md:text-sm sm:text-xs'>As a versatile software developer, I specialize in crafting dynamic web applications and cross-platform solutions, leveraging my proficiency in Java, C#, MySQL, React.js and React Native</p>

              <div className='flex items-center self-start mt-2 lg:self-center'>
                   {/* Add the Resume pdf file here  */}
                <Link href="/Resume_JayPatel.pdf" target={"_blank"} className='flex items-center bg-dark text-light p-2.5 px-6 
