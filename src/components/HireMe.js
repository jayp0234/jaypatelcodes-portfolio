...
const HireMe = () => {
  return (
    <div className='fixed left-1 bottom-1 flex items-center justify-center overflow-hidden lg:right-auto lg:left-[270px] lg:top-0 lg:bottom-[625px] lg:absolute md;left-[235px]'>
