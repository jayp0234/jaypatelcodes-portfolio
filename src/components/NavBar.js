...
<motion.a href="https://twitter.com/pateljay0234" target={"_blank"}
    whileHover={{ y: -4 }}
    whileTap={{ scale: 0.5 }}
    className="w-6 mr-3"
><TwitterIcon /></motion.a>

<motion.a href="https://github.com/jayp0234?tab=repositories" target={"_blank"}
    whileHover={{ y: -4 }}
    whileTap={{ scale: 0.5 }}
    className="w-6 mx-3"
><GithubIcon /></motion.a>
<motion.a href="https://www.linkedin.com/in/jaypatel0234/" target={"_blank"}
    whileHover={{ y: -4 }}
    whileTap={{ scale: 0.5 }}
    className="w-6 mx-3"
